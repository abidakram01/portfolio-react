    ...
    <>
      <main className="pt-20 lg:pt-[0rem] bg-[#020617] text-white min-h-screen">
        <section className="hero min-h-screen flex items-center relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between relative z-10 py-12 lg:my-10">
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Frontend Engineer 🛠️ | UI/UX Explorer 🎨 | Writing Clean Code & Building the Future, One Component at a Time 🚀
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a href="/images/Abid_Akram_UI_UX_Frontend_Dev_Resume.pdf" className="group relative inline-flex items-center justify-center gap-3 p-0.5 rounded-xl bg-gradient-to-r from-gray-800 to-gray-700 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_2rem_-0.5rem_#60A5FA]"
                >
              ...
              {/* Floating badges */}
              <div class="hidden lg:block absolute left-[10.5rem] top-[3.3rem] animate-float-slow animate-delay-[500ms]">
              ...
              <div class="hidden lg:block absolute right-10 top-20 animate-float animate-delay-[1000ms]">
              ...
              <div class="hidden lg:block absolute top-[17rem] left-[70%] transform -translate-x-1/2 animate-float-slow animate-delay-[1500ms]">
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 animate-bounce flex flex-col items-center gap-2">
