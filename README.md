...
![Portfolio Demo](https://i.postimg.cc/qvwcfp9h/Screenshot-2025-04-07-at-5-02-03-PM.png)
...
2. After forking, open your terminal and run the following commands to clone the repo:
  ...
  ```bash
  git clone https://github.com/abidakram01/portfolio-react.git
  ```
...
<div align="center"> Made with ❤️ by Abid Akram </div>
